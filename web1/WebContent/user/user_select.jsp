...
<body>
<script>
function goUser(userNum, param1)
{
	location.href = "<%=rootPath%>/user/user_info.jsp?usernum=" + userNum;	
}
function doSearchData()
{
	var searchTarget = document.getElementById("searchTarget").value;
	var searchStr = document.getElementById("searchStr").value;
	location.href = "<%=rootPath%>/user/user_select.jsp?searchTarget=" + searchTarget + "&searchStr=" + searchStr;
}
</script>
<div class="container">
...
try
{
	...
	while(rs.next())
	{
		...
		tableStr += "<td><a href='#javascript' onclick='goUser(" + rs.getInt("usernum") + ")'>" + rs.getString("userid") + "</a></td>";
